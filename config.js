...
const CONFIG = {
    ...
    questions: {
        ...
        third: {
            text: "Will you be my Valentine on February 14th, 2026? (plz say yes, i offer good food together and many fun and love 🌹", // The big question!
            yesBtn: "Yes",                                             // Text for "Yes" button
    ...
    celebration: {
        title: "Yay! I'm the luckiest person in the world :))) <3 ",
        message: "Next year we get to spend it together in person :))<3",
    ...
    music: {
        ...
        musicUrl: "https://res.cloudinary.com/dqrf9vrug/video/upload/v1770828310/Kanye_West_-_I_Wonder_but_the_intro_song_makes_you_ascend_joafeo.mp3", // Music streaming URL
